...
export default function ReferralPage() {
  ...
  // Capture referral from short link route: /r/<address>
  useEffect(() => {
	...
	// (UX choice: user lands on purchase page right away)
	try {
	  // keep history clean
...
/*
// ------------------ Tests (Vitest + RTL) ------------------
// Эти тесты примерные: включи их, когда в проекте уже настроены vitest и @testing-library/react.
// import { render, screen } from '@testing-library/react'
// import { describe, it, expect } from 'vitest'
//
// describe('ReferralPage UI', () => {
//   it('shows connect CTA when disconnected', () => {
//     render(<WalletRequired onConnect={() => {}} />)
